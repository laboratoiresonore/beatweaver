...
```
192\.168\.86\.(31|23|77|219)|lmlgg|leguillaume|@gmail\.com|ghp_[A-Za-z0-9]
```

These are the same identity / Theo-network markers Whimweaver's Claude hook
catches. See master plan §F.6.2 Wk 1 Thu / §10.7 for the lattice rationale.
...
Canonical script vendored from `voodoo-core/hooks/pre-commit` (master plan §C
once voodoo-core ships at week 5–19; until then, vendored verbatim per repo).
